...
parser = argparse.ArgumentParser(
    description="Build CM track and content files from DAGs ©Olga Pushkarev"
)
...
logging.info("####################################################################")
logging.info("# Build CM track and content files from DAGs ©Olga Pushkarev #")
logging.info("####################################################################")
logging.info("\nList of arguments:\n")
logging.info("Input:")
...
# 1. Find the naive lead variant by merging the input file and the posterior
# probability “pp.gz" given by hm. The 4th column of pp.gz gives the
# posterior probability of a variant being causal QTL for each peak.
# You can simply pick up one gives the highest value within each peak
